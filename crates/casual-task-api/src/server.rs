...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        // C-002 — workspaces, membership, teams.
        //
        // Every one of these is registered HERE, above the layers, for the
        // reason this function's docs give: a route appended to the returned
        // Router escapes the CSRF guard and the request id.
        .route(
            "/api/v1/workspaces",
