...
**Phase 1 is under way, and all of it is engine.** 11 items started, 1 gated:
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 1/19 (1 built, 9 building) | `░░░░░░░░░░` 5% |
