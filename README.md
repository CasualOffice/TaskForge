...
**Phase 1 is under way, and all of it is engine.** 15 items started, 1 gated:
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 1/20 (2 built, 12 building) | `░░░░░░░░░░` 5% |
