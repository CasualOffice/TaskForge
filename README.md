...
**Phase 1 is under way.** 32 items started, 9 gated:
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 9/33 (10 built, 13 building) | `███░░░░░░░` 27% |
