...
**Phase 1 is under way, and all of it is engine.** 12 items started, 1 gated:
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 1/20 (1 built, 10 building) | `░░░░░░░░░░` 5% |
