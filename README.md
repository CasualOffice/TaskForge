...
**Phase 1 is under way.** 28 items started, 7 gated:
...
- **State-occupancy projection — `task_state_interval`, maintained and rebuildable** (C-029) — `Built`
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 7/29 (8 built, 13 building) | `██░░░░░░░░` 24% |
