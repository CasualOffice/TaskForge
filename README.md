...
**Phase 1 is under way, and all of it is engine.** 8 items started, 0 gated:
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 0/19 (8 building) | `░░░░░░░░░░` 0% |
