...
**Phase 1 is under way.** 24 items started, 3 gated:
...
- **Releases — what went out together, cut from the pipeline** (C-023) — `Built`
- **Team scope — team as a place to stand, beside project and workspace** (C-024) — `Built`
...
| **1 — Usable core** | auth, projects, tasks, workflow, outbox, search, **then** the web client | 3/25 (8 built, 13 building) | `█░░░░░░░░░` 12% |
