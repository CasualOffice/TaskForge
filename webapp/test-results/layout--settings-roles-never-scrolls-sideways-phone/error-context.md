...
- Name: layout.spec.ts >> /settings/roles never scrolls sideways
    ...
    - main [ref=e56]:
      - generic [ref=e57]:
        ...
        - paragraph [ref=e82]:
          ...
          - code [ref=e83]: role.assign
          - text: in this workspace. Someone with it can grant it to you under Roles.
  - status [ref=e84]
```
